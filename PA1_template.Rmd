...
Mean is `r round(mean_per_day,digits=3)`and median is `r round(median_per_day,digits=3)`
```{r}
...
Max average number of steps, `r round(max_value,digits=3)`, happens at 5 min interval `r max_interval`
